 ...
 * @property {string[]} [images] Every image URL a provider found for this listing, in provider
 *   order, capped at the configured `maxImagesPerListing`. Absent or a single entry means the
 *   provider only ever surfaces one image; `image` always equals `images[0]` when both are set.
