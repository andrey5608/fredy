...
export const init = (sourceConfig, blacklist) => {
  ...
  if (process.env.NODE_ENV === 'test') {
    // Avoid live network calls during unit tests; return predictable mock listings instead.
      ...
      return [
        {
          ...
          price: '1.000 €',
          size: '55 m²',
          title: 'Mock ImmoSWP Listing',
          link: 'https://immo.swp.de/immobilien/mock-immoswp-1',
          description: 'Test fixture listing for immoswp',
