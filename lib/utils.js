...
/**
 * {@link normalizeImageUrl}, over a list. Invalid entries are dropped rather than kept as null,
 * and duplicates - two providers occasionally list the same CDN url twice - are removed, so a
 * caller building a notification never has to filter the result itself.
 *
 * @param {any[]|null|undefined} urls
 * @returns {string[]}
 */
